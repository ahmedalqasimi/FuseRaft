 ...
 * This file demonstrates how to integrate Fuseraft with a web frontend
 */

// For React/Vue/Angular applications
export class FuseraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FuseraftClient(provider, contractAddress);
